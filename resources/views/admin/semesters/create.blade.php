<x-app-layout>
    ...
    <div class="d-block d-md-none mobile-page-content">
        <div class="mobile-section-header">
            <a href="{{ route('admin.semesters.index') }}" class="btn btn-light border btn-sm mb-2" style="display:inline-flex;align-items:center;gap:6px;">
                <i class="bi bi-arrow-left"></i> Kembali
            </a>
            <h3 class="mobile-heading">Tambah Semester</h3>
            <p class="mobile-subtitle">Hubungkan semester baru dengan tahun ajaran</p>
        </div>
    </div>
                    ...
                    <form method="POST" action="{{ route('admin.semesters.store') }}">
                        ...
                        <div class="row mobile-form-row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: Ganjil" value="{{ old('name') }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
