...
<div class="container-fluid px-4">
    ...
    <div class="d-none d-lg-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Buat akun login baru untuk petugas piket gerbang.</p>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info d-flex gap-2 align-items-start mb-4">
                        ...
                        <div class="small">
                            Akun ini digunakan bersama di perangkat scan gerbang. Setelah login, petugas
                            mengisi nama masing-masing setiap sesi. Disarankan menggunakan password sederhana
                            seperti <code>piket123</code> agar mudah diingat oleh petugas piket.
                        </div>
                    </div>

                    <form method="POST" action="{{ route('admin.guru-piket-accounts.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name"
                                   ...
                                   value="{{ old('name') }}"
                                   placeholder="Contoh: Akun Piket Gerbang"
                                   required autofocus>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Label identifikasi untuk akun ini.</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email" name="email"
                                   ...
                                   value="{{ old('email') }}"
                                   placeholder="piket@sekolah.sch.id"
                                   required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Minimal 6 karakter. Disarankan: <code>piket123</code></div>
                        </div>
