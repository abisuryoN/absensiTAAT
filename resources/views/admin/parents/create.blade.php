<x-app-layout>
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <h3 class="fw-bold tracking-tight text-dark mb-1">Tambah Orang Tua / Wali</h3>
            <p class="text-muted mb-0">Buat profil orang tua atau wali siswa baru.</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.parents.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 border-end pe-md-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text fs-8">Gunakan format angka saja (cth: 0812...).</div>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="phone_secondary" class="form-label fw-semibold">No. HP Cadangan</label>
                            <input type="text" name="phone_secondary" id="phone_secondary" class="form-control @error('phone_secondary') is-invalid @enderror" placeholder="Contoh: 0857..." value="{{ old('phone_secondary') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3" placeholder="Masukkan alamat lengkap rumah...">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 ps-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="orangtua@email.com" value="{{ old('email') }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="Masukkan password (minimal 6 karakter)">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text fs-8">Default password jika dikosongkan adalah "parent123".</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4 border-top pt-3">
                    <button type="submit" class="btn btn-primary fw-semibold px-4">
                        <i class="bi bi-save me-1"></i> Simpan Orang Tua
                    </button>
                </div>
            </form>
        </div>
