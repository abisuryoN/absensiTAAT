    ...
    <div class="sidebar-nav-container flex-grow-1">
        <ul class="nav nav-pills flex-column sidebar-menu">
            ...
            @if(auth()->user()->hasRole('super_admin'))
                <li class="nav-item-header text-uppercase px-4 py-2 sidebar-section-label">Menu Utama</li>
                ...
                <li class="nav-item-header text-uppercase px-4 py-2 sidebar-section-label">Master Data</li>
                <li class="sidebar-menu-item">
                ...
                <li class="nav-item-header text-uppercase px-4 py-2 sidebar-section-label">Laporan & Pengaturan</li>
                <li class="sidebar-menu-item">
            ...
            @if(auth()->user()->hasRole('guru'))
                <li class="nav-item-header text-uppercase px-4 py-2 sidebar-section-label">Menu Guru</li>
                <li class="sidebar-menu-item">
            ...
            @if(auth()->user()->hasRole('siswa'))
                <li class="nav-item-header text-uppercase px-4 py-2 sidebar-section-label">Menu Siswa</li>
                <li class="sidebar-menu-item">
